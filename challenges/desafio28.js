...
// e crie uma query que insira na coleção resumoVoos um documento com os campos: empresa (nome da empresa)
// e totalVoosDomesticos (o total retornado anteriormente).

// Em uma segunda query, retorne a empresa e o totalVoosDomesticos do primeiro documento presente na coleção
// resumoVoos em que a empresa seja LATAM AIRLINES BRASIL.
...
db.resumoVoos.find({"empresa.nome": "LATAM AIRLINES BRASIL"}, {"_id":0}).limit(1);
